...
const SNCard = ({
  ...
  return (
    <div className="sn-card cursor-pointer" onClick={onClick}>
      <div className="shadow-2 pb-[1rem] rounded-t-xl bg-white">
        <div className="relative">
          <Image
            className="w-[100%] h-[70px] rounded-t-xl object-cover object-center"
          ...
          />
          <div className="absolute bottom-[-30px]  w-full flex justify-center rounded-full">
            <SNAvatar
